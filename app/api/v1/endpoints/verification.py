...
from app.dependencies import get_verification_service, get_current_user_id
...
async def verify_user(request: Request, token: str, service: VerificationService = Depends(get_verification_service), current_user_id: UUID = Depends(get_current_user_id)):
